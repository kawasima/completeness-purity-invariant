...
import net.unit8.example.invariant.incompleteness.address.ExistsAddressService;
...
class DeliverOrderHandlerImplTest {
    ...
    void setup() {
        ...
        ExistsAddressPort existsAddressPort = new ExistsAddressService();
        sut = new DeliverOrderHandlerImpl(loadOrderPort, existsAddressPort, saveOrderPort);
    }
