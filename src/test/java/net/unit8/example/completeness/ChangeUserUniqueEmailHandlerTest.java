...
import net.unit8.example.completeness.ChangeUserUniqueEmailHandler.ChangeUserEmailCommand;
import net.unit8.example.completeness.ChangeUserUniqueEmailHandler.ChangedUserEmailEvent;
...
class ChangeUserUniqueEmailHandlerTest {
    ChangeUserUniqueEmailHandler sut;
    ...
    void setup() {
        ...
        sut = new ChangeUserUniqueEmailHandler(loadUserPort, existsEmailPort, saveUserPort);
    }
